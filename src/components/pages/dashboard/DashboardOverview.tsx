    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-6 bg-white dark:bg-gray-900 rounded border border-gray-200 dark:border-gray-800 shadow-sm flex items-center gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 rounded border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
