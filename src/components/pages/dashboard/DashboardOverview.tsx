    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-6 bg-white rounded border border-gray-200 shadow-sm flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center">
                        <Package className="w-6 h-6" />
                    </div>
                    <div>
                        <h4 className="font-bold text-2xl text-text-main">154</h4>
                ...
                <div className="p-6 bg-white rounded border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-2xl text-text-main">05</h4>
                ...
                <div className="p-6 bg-white rounded border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-2xl text-text-main">149</h4>
                ...
                <div className="p-6 bg-white rounded border border-gray-200 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-2xl text-text-main">02</h4>
            ...
            <div className="bg-white rounded border border-gray-200 shadow-sm overflow-hidden">
                <div className="p-6 flex items-center justify-between border-b border-gray-200">
                    <h2 className="font-bold text-lg text-text-main">Recent Order History</h2>
                    <button className="text-primary text-sm font-medium hover:underline">View All</button>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50 text-text-muted text-xs uppercase font-bold">
