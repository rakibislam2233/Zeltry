        ...
        <form className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-gray-200">
            <div className="relative group">
              ...
              <button
                type="button"
                className="absolute bottom-0 right-0 bg-white p-1.5 rounded-full border border-gray-200 text-text-main transition-colors"
              >
          ...
          <div className="pt-4 flex justify-end">
            <button
              type="button"
              className="flex items-center gap-2 bg-primary text-white px-6 py-3 rounded font-bold transition-all"
            >
