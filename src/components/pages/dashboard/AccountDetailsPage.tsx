...
const AccountDetailsPage = () => {
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-text-main">Account Details</h2>
                ...
                <form className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-gray-200">
                        <div className="relative group">
                            ...
                            <button type="button" className="absolute bottom-0 right-0 bg-white p-1.5 rounded-full border border-gray-200 text-text-main shadow-sm hover:text-primary transition-colors">
                                <Camera className="w-4 h-4" />
                            </button>
                        </div>
                        <div className="text-center sm:text-left">
                            <h3 className="font-bold text-text-main">Profile Photo</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                type="text"
                                defaultValue="Alex"
                                className="w-full px-4 py-2.5 rounded border border-gray-200 bg-transparent focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all"
                            />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                        <h3 className="font-bold text-lg text-text-main mb-6">Change Password</h3>
