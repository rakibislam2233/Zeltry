...
const products: Product[] = [
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAg8LlpFfcR4zejaOavRfLzi0-24QtRk9fppYdqaOSikpcVlEtDmE-85iODdXYDalWB05rqpWrHKiv5ZhdhokZ4diOXVGIygqXyL7mYySoTxFl3ZZtxkMjed0Qijx_8EENjxd5yV6ltO57y1csPmVl_gDgW_8CW5He42ldN32iHaoZuGH2O8wNB8Akr9C3XUXtLlmKmkZriA3iJfpbyLdACvbozeUeO6hdEr1pTmIQs9K2gGylVxo1ctJ8ScCfbTJHaFXnD-JZXaD8Q",
    rating: 4.2,
    price: 1.2,
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuC6mgV6lX8WChUELpHZiIAtgPXQR-QEZPaW32QPXH1Z53EZxJpR3dYVXHScH8kQNuZGsPolbREsh-pnaRonUotbXvWZWt0GIO-ClzRL_O1yVSk4JV9EWXj_Jb0_BSfoaYgsTqwjbm5_b95ORECD6M3KHq5tAxlQ1mGbFPgDymHDBYm2buecXkm5vmnBUmlGh49KeMAx7zl26uOSVUrP7XMSGqUWoMrD9rvm9O_1pJrodbko-9kLoZWKqO6BIv8i-wnXWpE-hpz-kRvZ",
    rating: 4.7,
    price: 3.15,
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAHi-aEQHAAfU-Y430UFBx4S8IT5iGggbStf6KVuSTH0mroyH4E-Z2UA7nuxFaCg4EHqHuAp4UdDdeNSNqdUMTaR7AiN4mkFTnf3qj9WMCQzWT2Q_xczdM-q3uZ0igwybg2mtpVmRD5xlAyOjyvnTUINOMjzNaFhi9-Fgwe5Mu7yVmOa_dnbiS72_8qUcT0W6tcBjYqprhieUSRWZUEWab4izSTb0hovuw5mqoG4ZxRm29h2tqkUcVa8aIH4dJAljz366Fp3DEHPxFQ",
    rating: 4.9,
    price: 4.5,
  },
];
...
const dealItems = products.map((item, index) => ({
  ...item,
  brand:
    ["NestFood", "Old El Paso", "Progressio", "Yoplait"][index] ?? "NestFood",
  countdown: [
