        ...
        <div className="bg-white rounded border border-gray-200 p-6 shadow-sm">
                ...
                {[1, 2].map(i => (
                    <div key={i} className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <h4 className="text-sm font-medium text-text-main line-clamp-1">Green Apple</h4>
                            <p className="text-xs text-text-muted">x5</p>
                        </div>
                        <span className="font-bold text-sm text-text-main">$70.00</span>
                    </div>
                ))}
            </div>
            ...
            <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-text-main">$84.00</span>
                </div>
                <div className="flex items-center justify-between text-sm">
            ...
            <h3 className="font-bold text-text-main mb-4">Payment Method</h3>
            ...
            <div className="space-y-3 mb-6">
                <label className="flex items-center gap-3 cursor-pointer group">
                    ...
                    <span className="text-sm font-medium text-text-main group-hover:text-primary transition-colors">Cash on Delivery</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative flex items-center">
                    ...
                    <span className="text-sm font-medium text-text-main group-hover:text-primary transition-colors">Paypal</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative flex items-center">
                        <input type="radio" name="payment" className="peer w-5 h-5 appearance-none border-2 border-gray-300 rounded-full checked:border-primary checked:border-[5px] transition-all" />
                    </div>
                    <span className="text-sm font-medium text-text-main group-hover:text-primary transition-colors">Amazon Pay</span>
                </label>
            </div>
