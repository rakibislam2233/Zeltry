            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 xl:p-16 bg-white">
                <div className="w-full max-w-[550px] space-y-8">
                    ...
                    <Link href="/" className="flex items-center gap-2 mb-8 w-fit bg-primary/10 px-4 py-2 rounded-full">
                        ...
                        <span className="font-bold text-lg text-text-main">Zeltry</span>
                    </Link>

                    <div>
                        <h1 className="text-4xl font-bold text-text-main mb-2">Create Account</h1>
                    ...
                    <form className="space-y-6">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            ...
                            <span className="text-sm text-text-muted group-hover:text-text-main transition-colors">I agree to the <a href="#" className="font-medium text-text-main underline decoration-gray-300 hover:decoration-primary">Terms & Conditions</a> and <a href="#" className="font-medium text-text-main underline decoration-gray-300 hover:decoration-primary">Privacy Policy</a>.</span>
                        </label>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-white text-text-muted">Or register with</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <button className="flex items-center justify-center gap-3 px-4 py-3 rounded border border-gray-200 hover:bg-gray-50 transition-colors">
                            ...
                            <span className="font-medium text-text-main">Facebook</span>
                        </button>
                    </div>
