        ...
        <div className="min-h-screen w-full flex items-center justify-center p-4 bg-white dark:bg-gray-950">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="flex justify-center mb-8">
                    <Link href="/" className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                ...
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-text-main dark:text-white mb-2">Forgot Password?</h1>
                    <p className="text-text-muted">No worries! Enter the email address associated with your account and we'll send you a link to reset your password.</p>
                </div>
